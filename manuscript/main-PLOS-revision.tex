...
%TC:endignore
    ...
    As implemented in \textcite{tataru_inference_2017}, the DFE is a mixture between a reflected gamma distribution and an exponential distribution (eq.~\ref{eq:parametric-dfe}, section~\ref{subsec:precisison_recall} in Materials \& Methods).
    ...
    Measuring the ``rate of adaptation'' in proteins, as pioneered by \textcite{mcdonald_adaptative_1991}, has been central to inform this debate~\cite{galtier_half_2024}.
    ...
    Moreover, the goal is not to detect a fraction of beneficial substitution (i.e. ``adaptive'' substitutions for \textcite{mcdonald_adaptative_1991}), but to estimate the proportion of non-adaptive mutations among beneficial ones.
