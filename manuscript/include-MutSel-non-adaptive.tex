...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Bos_taurus.IRBT.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Bos_taurus.IRBT.MutSel.polyDFE_C.pdf}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Bos_taurus.UGBT.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Bos_taurus.UGBT.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.AUCH.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.AUCH.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.FRCH.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.FRCH.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.IRCA.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.IRCA.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.IRCH.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.IRCH.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.ITCH.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.ITCH.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.MOCH.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Capra_hircus.MOCH.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Barbados.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Barbados.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Central_African_Republic.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Central_African_Republic.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Ethiopia.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Ethiopia.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Gambia.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Gambia.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Kenya.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Kenya.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Nevis.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Nevis.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Saint_Kitts.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Saint_Kitts.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.South_Africa.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.South_Africa.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Zambia.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Chlorocebus_sabaeus.Zambia.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Equus_caballus.up.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Equus_caballus.up.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.AFR.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.AFR.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.AMR.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.AMR.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.EAS.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.EAS.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.EUR.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.EUR.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.SAS.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Homo_sapiens.SAS.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROA.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROA.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROO.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROO.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROV.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.IROV.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.ISGC.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.4\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.ISGC.MutSel.polyDFE_C.pdf}
\end{minipage}
\begin{minipage}{0.09\linewidth}
    \includegraphics[width=\linewidth, page=1]{artworks/legend.polycat.top}
\end{minipage}
...
\\
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.MOOA.MutSel-sfs.normalize.pdf}
\end{minipage}
\begin{minipage}{0.49\linewidth}
    \includegraphics[width=\linewidth, page=1]{../experiments/5bins-all/analysis/Ovis_aries.MOOA.MutSel.polyDFE_C.pdf}
\end{minipage}
\\
