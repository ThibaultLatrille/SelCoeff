...
\begin{document}
    ...
    In the first scenario, a change of environment will modify the fitness of the individuals and the bearer of the mutation that is advantageous in the new environment will be better adapted.
    Its chances of survival and reproduction will be higher and this process is typically referred to as adaptive evolution (fig.~\ref{fig:fitness-landscape}A).
    ...
    However, the exact causes for this widespread occurrence of positive selection have been scarcely investigated\NS{is it the case in the conclusion of the previous paper?? would be nice to back it up with references}.
    ...
    \textbf{Funding:}
    Université de Lausanne; French National Research Agency, Grant ANR-15-CE12-0010-01 / DASIRE.
