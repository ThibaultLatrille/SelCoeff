    ...
    \begin{table*}[tb]
        ...
        \begin{adjustbox}{width=\textwidth}
            \begin{tabular}{||l|l|r||r|r||r|r||r|r||}
                \toprule
                \multicolumn{3}{||c||}{} &
                \multicolumn{2}{c||}{\shortstack{\textbf{Deleterious mutations} \\ $\bm{\Spop^{\text{d}} \coloneqq \Spop<-1}$ \\ $\bm{\Sphy^{\text{d}} \coloneqq \Sphy<-1}$}} &
                \multicolumn{2}{c||}{\shortstack{\textbf{Nearly-neutral mutations} \\ $\bm{\Spop^{\text{n}} \coloneqq -1<\Spop<1}$ \\ $\bm{\Sphy^{\text{n}} \coloneqq -1<\Sphy<1}$}} &
                \multicolumn{2}{c||}{\shortstack{\textbf{Beneficial mutations} \\ $\bm{\Spop^{\text{b}} \coloneqq \Spop>1}$ \\ $\bm{\Sphy^{\text{b}} \coloneqq \Sphy>1}$}}
                \\ \hline
                \textbf{Population} &
                \textbf{Species} &
                $\bm{\pi_{\text{S}}}$ &
                \makecell{\textbf{Precision} \\ $\bm{\proba [\Spop^{\text{d}} \given \Sphy^{\text{d}}]}$} &
                \makecell{\textbf{Recall} \\ $\bm{\proba [\Sphy^{\text{d}} \given \Spop^{\text{d}}]}$}             &
                \makecell{\textbf{Precision}      \\ $\bm{\proba [\Spop^{\text{n}} \given \Sphy^{\text{n}}]}$}                 &
                \makecell{\textbf{Recall}          \\ $\bm{\proba [\Sphy^{\text{n}} \given \Spop^{\text{n}}]}$}               &
                \makecell{\textbf{Precision}          \\ $\bm{\proba [\Spop^{\text{b}} \given \Sphy^{\text{b}}]}$}            &
                \makecell{\textbf{Recall}        \\ $\bm{\proba [\Sphy^{\text{b}} \given \Spop^{\text{b}}]}$}
                \\   \midrule
