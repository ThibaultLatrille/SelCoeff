...
\begin{document}
    ...
    %At the scale of a population, adaptive evolution and maintenance positive selection display different dynamics.
    ...
    %This process is typically referred to as adaptive evolution (fig.~\ref{fig:fitness-landscape}A), and meets the eco-evolutionary definition of adaptation.
