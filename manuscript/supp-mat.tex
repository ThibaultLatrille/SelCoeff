...
\begin{document}
    ...
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.all_P-Ssup0.scatter.pdf}
    \end{minipage}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.pos_P-Ssup0.scatter.pdf}
    \end{minipage}

    \subsubsection{Proportion of negative selection}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.all_P-Sinf0.scatter.pdf}
    \end{minipage}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.neg_P-Sinf0.scatter.pdf}
    \end{minipage}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.neg-strong_P-Sinf0.scatter.pdf}
    \end{minipage}

    \subsubsection{Proportion of weak selection}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.all_P-Seq0.scatter.pdf}
    \end{minipage}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.neg-weak_P-Seq0.scatter.pdf}
    \end{minipage}
    \begin{minipage}{0.32\linewidth}
        \includegraphics[width=\linewidth, page=1]{../experiments/5cat-polyDFE-mC-non-adaptive/regression/results.watterson.pos-weak_P-Seq0.scatter.pdf}
    \end{minipage}
