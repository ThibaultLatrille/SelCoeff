...
%DIF DEL main-PNAS-revision.tex     Sun Oct 15 00:20:50 2023
%DIF ADD main-PNAS-revision-2.tex   Mon Apr 22 10:15:34 2024
%TC:ignore
...
\cite{ohta_nearly_1992}}\hskip0pt%DIFAUXCMD
    ...
    For instance, in the mammalian protein-coding DNA alignment of gene }\textit{\DIFadd{SELE}}\DIFadd{, the nucleotide at site 1722 has mutated (from T to C) at the base of Simiiformes (monkeys and apes), modifying the corresponding amino acid from Serine to Proline, but has been subsequently reverted in the branch of }\textit{\DIFadd{Chlorocebus sabaeus}} \DIFadd{(fig.~S2).
    However, other substitutions classified as $\SphyBen$ in the terminal branch of }\textit{\DIFadd{Chlorocebus sabaeus}} \DIFadd{cannot be clearly interpreted as reversions along the terminal branch, and show several transitions to this amino acid across the mammalian phylogeny, as for instance site 3145 of gene }\textit{\DIFadd{THSD7A}} \DIFadd{(fig.~S3).
}
